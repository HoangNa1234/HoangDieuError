 ...
 * @author LENOVO
 */
public class employeegicGUI extends javax.swing.JFrame {

    /**
     * Creates new form employeegicGUI
     */
    public employeegicGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tlbSinhVien = new javax.swing.JTable();
        ...
        cbHoclucSV.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Xuất sắc", "Giỏi", "Khá", "Trung bình", "Yếu" }));
        ...
        tlbSinhVien.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tlbSinhVien);
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(cbHoclucSV, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        tbPanel.addTab("Sinh viên", jPanel1);
    ...
    private void btnNhapSVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNhapSVActionPerformed
        ...
        Student1 obj = new Student1(txtTruong.getText(),
                cbHoclucSV.getSelectedItem().toString(),
                txtHotenSV.getText(),
      ...
      case"Giỏi":
        ...
        DefaultTableModel model = (DefaultTableModel) tlbSinhVien.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(employeegicGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new employeegicGUI().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tlbSinhVien;
